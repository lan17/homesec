...
- **Push-to-talk**: Browser microphone to camera speaker support is opt-in globally and per camera. The MVP supports RTSP cameras with ONVIF audio backchannel and `PCMU/8000`; keep credentials in environment variables and validate each camera before enabling. See [`docs/push-to-talk.md`](docs/push-to-talk.md).
