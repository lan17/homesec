...
class APIErrorCode(StrEnum):
    ...
    SETUP_FINALIZE_INVALID = "SETUP_FINALIZE_INVALID"
    ...
    MEDIA_TOKEN_REJECTED = "MEDIA_TOKEN_REJECTED"
    PREVIEW_MEDIA_UNAVAILABLE = "PREVIEW_MEDIA_UNAVAILABLE"
    PREVIEW_TOKEN_REJECTED = "PREVIEW_TOKEN_REJECTED"
    PREVIEW_CAMERA_NOT_FOUND = "PREVIEW_CAMERA_NOT_FOUND"
    PREVIEW_RECORDING_PRIORITY = "PREVIEW_RECORDING_PRIORITY"
    PREVIEW_SESSION_BUDGET_EXHAUSTED = "PREVIEW_SESSION_BUDGET_EXHAUSTED"
    PREVIEW_TEMPORARILY_UNAVAILABLE = "PREVIEW_TEMPORARILY_UNAVAILABLE"
    PREVIEW_RUNTIME_UNAVAILABLE = "PREVIEW_RUNTIME_UNAVAILABLE"
    TALK_CAMERA_NOT_FOUND = "TALK_CAMERA_NOT_FOUND"
    TALK_TOKEN_REJECTED = "TALK_TOKEN_REJECTED"
    TALK_DISABLED = "TALK_DISABLED"
    TALK_SOURCE_NOT_TALK_CAPABLE = "TALK_SOURCE_NOT_TALK_CAPABLE"
    TALK_SESSION_ALREADY_ACTIVE = "TALK_SESSION_ALREADY_ACTIVE"
    TALK_SESSION_BUDGET_EXHAUSTED = "TALK_SESSION_BUDGET_EXHAUSTED"
    TALK_UNSUPPORTED_CAMERA = "TALK_UNSUPPORTED_CAMERA"
    TALK_UNSUPPORTED_CODEC = "TALK_UNSUPPORTED_CODEC"
    TALK_CAMERA_BACKCHANNEL_FAILED = "TALK_CAMERA_BACKCHANNEL_FAILED"
    TALK_RUNTIME_UNAVAILABLE = "TALK_RUNTIME_UNAVAILABLE"
    TALK_INVALID_AUDIO_FRAME = "TALK_INVALID_AUDIO_FRAME"
    TALK_BACKPRESSURE = "TALK_BACKPRESSURE"
    CLIP_DELETE_MARK_FAILED = "CLIP_DELETE_MARK_FAILED"
    ...
    ONVIF_DISCOVER_FAILED = "ONVIF_DISCOVER_FAILED"
    ONVIF_PROBE_TIMEOUT = "ONVIF_PROBE_TIMEOUT"
    BAD_REQUEST = "BAD_REQUEST"
    NOT_FOUND = "NOT_FOUND"
    CONFLICT = "CONFLICT"
    SERVICE_UNAVAILABLE = "SERVICE_UNAVAILABLE"
    INTERNAL_SERVER_ERROR = "INTERNAL_SERVER_ERROR"
    ONVIF_PROBE_FAILED = "ONVIF_PROBE_FAILED"
