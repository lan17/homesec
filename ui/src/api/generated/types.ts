...
export type PreviewSessionResponse = components["schemas"]["PreviewSessionResponse"]
export type PreviewState = components["schemas"]["PreviewState"]
export type PreviewStatusResponse = components["schemas"]["PreviewStatusResponse"]
export type PreviewStopResponse = components["schemas"]["PreviewStopResponse"]
export type TalkInputFormat = components["schemas"]["TalkInputFormat"]
export type TalkSessionRequest = components["schemas"]["TalkSessionRequest"]
export type TalkSessionResponse = components["schemas"]["TalkSessionResponse"]
export type TalkCapabilityState = components["schemas"]["TalkCapabilityState"]
export type TalkState = components["schemas"]["TalkState"]
export type TalkStatusResponse = components["schemas"]["TalkStatusResponse"]
export type TalkStopResponse = components["schemas"]["TalkStopResponse"]
...
export type PostgresBackupStatusResponse = components["schemas"]["PostgresBackupStatusResponse"]
export type PostgresBackupRunResponse = components["schemas"]["PostgresBackupRunResponse"]
