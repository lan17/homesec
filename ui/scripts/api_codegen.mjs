...
function buildTypesFile({
  ...
  storageSchemaName,
  storageUpdateSchemaName,
  storageChangeSchemaName,
  storageBackendSchemaName,
...
function generateOpenApiArtifacts(tempGeneratedDir) {
  ...
  const storageSchemaName = resolveResponseSchemaName(schema, {
    pathName: '/api/v1/storage',
    method: 'get',
    statuses: ['200', 'default'],
    fallbackSchemaName: 'StorageResponse',
  })
  const storageUpdateSchemaName = resolveRequestBodySchemaName(schema, {
    pathName: '/api/v1/storage',
    method: 'patch',
    fallbackSchemaName: 'StorageUpdate',
  })
  const storageChangeSchemaName = resolveResponseSchemaName(schema, {
    pathName: '/api/v1/storage',
    method: 'patch',
    statuses: ['200', 'default'],
    fallbackSchemaName: 'StorageChangeResponse',
  })
  const storageBackendSchemaName = resolveArrayItemResponseSchemaName(schema, {
    pathName: '/api/v1/storage/backends',
    method: 'get',
    statuses: ['200', 'default'],
    fallbackSchemaName: 'StorageBackendMetadata',
  })
